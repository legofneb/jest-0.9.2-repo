...
declare module 'd3-cloud' {
    export default function cloud(): Cloud<cloud.Word>;
    export default function cloud<T extends cloud.Word>(): Cloud<T>;
    ...
    interface Cloud<T extends cloud.Word> {
        ...
        random(value: number): Cloud<T>;
        random(value: (datum: T, index: number) => number): Cloud<T>;
    }
}